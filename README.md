# nvim-treesitter-queries-poe_filter

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-poe_filter/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-poe_filter/actions/workflows/validate.yml)

Neovim tree-sitter queries for **poe_filter**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-poe_filter",
...
- [ ] Changes are scoped to `poe_filter` — do not include files for other languages
